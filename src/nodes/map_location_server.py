...
def handler_map_location(req):
    ...
    x_gyro, y_gyro, t_gyro, acurracy_x_gyro, acurracy_y_gyro = gyroD['X_GYRO'], gains['Y_GYRO'], gains['T_GYRO'], gains['ACURRACY_X_GYRO'], gains['ACURRACY_Y_GYRO']
    rospy.loginfo("gyroD are %s, %s, %s, %s, %s", x_gyro, y_gyro, t_gyro, acurracy_x_gyro, acurracy_y_gyro)
    x_gps, y_gps, t_gps, acurracy_x_gps, acurracy_y_gps = gpsD['X_GPS'], gains['Y_GPS'], gains['T_GPS'], gains['ACURRACY_X_GPS'], gains['ACURRACY_Y_GPS']
...
def map_location_server():
    ...
    print "Ready to add two ints." #AddTwoIntsRequest = map.locationRequest
    #//////////////////////
    rate = rospy.Rate(4)
